...
This project has been developed with assistance from artificial intelligence tools. This document provides transparency regarding the role of AI in the development process.
...
This project is provided as-is. Until version 1.0.0 is released with full human review, users should:

1. Not rely on this project for production high-security applications without independent review
